...
## 🔴 先看这条：真正在开发的是 `echo-h5-proto/`，不是 `echo-client/`
...
| `echo-client/` | 更早的 Unity 尝试 | **已冻结**，自版本控制基线起没有一次实质改动，71 个文件 |

名字像主角的那个是冻结的旧工程。单仓时代这个撞车已经被记过一笔
（echo-doc 仓 `docs/PLAN-repo-split.md` §3），当时的风险是「拆分时按名字推错仓」；
现在两者同仓，风险变成「新人 clone 下来照名字找错目录」。
